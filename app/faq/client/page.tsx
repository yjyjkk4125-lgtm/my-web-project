...
const items = [
  ...
  },
  {
    ...
    a: "고객님의 니즈에 적합한 전문가가 확인되면, 등록하신 연락처로 전문가 프로필을 전달해 드립니다. 매칭 확정 시 카카오톡이나 메일로 전용 결제 링크를 보내드리며, 이를 통해 간편하게 결제를 완료하실 수 있습니다.",
  },
  {
    q: "상담은 어떤 방식으로 이뤄지나요?",
  ...
  {
    q: "결제 방식은 무엇이 있나요?",
    a: "신용카드, 간편 결제, 계좌이체 모두 가능합니다. 전용 결제 링크를 통한 카드 결제가 기본이며, 비아로컬 지정 계좌로 직접 입금해주시는 방식도 지원합니다. 입금 확인 시 고객님의 요청에 따라 현금영수증 또는 세금계산서를 즉시 발행해 드립니다.",
  },
];
