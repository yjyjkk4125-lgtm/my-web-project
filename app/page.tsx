...
const faqs = [
  ...
  },
  {
    ...
    a: "가능합니다. 현재 상황을 정리하는 단계부터 시작할 수 있습니다.",
  },
  {
    q: "자문 후 추가 연결도 가능한가요?",
    a: "필요 시 추가 자문이나 후속 연결이 가능합니다.",
  },
  {
    q: "기밀 정보는 안전하게 보호되나요?",
    a: "비아로컬은 전문가와 브랜드 간의 신뢰를 중요하게 생각하며 기밀성과 정보 보호를 최우선으로 운영합니다.",
  },
];
