...
const steps = [
  ...
  },
  {
    ...
    title: "실시간 자문 진행",
    body: [
      "정해진 시간 동안 1:1 전화 또는 화상 방식으로 실무 자문이 진행됩니다.",
      "브랜드가 현재 겪고 있는 문제와 방향성을 함께 정리하며,",
      "실무 경험 기반의 현실적인 조언과 실행 방향을 중심으로 이야기를 나눕니다.",
    ],
    examples: [],
    note: null,
  },
...
const notices = [
  ...
  "브랜드 상황과 목표에 따라 필요한 실행 방향과 전략은 달라질 수 있습니다.",
];
